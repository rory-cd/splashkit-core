...
typedef __sklib_ptr __sklib_adc_device;
...
typedef int __sklib_gpio_pin_mode;
typedef int __sklib_gpio_pin_value;
typedef int __sklib_http_status_code;
typedef int __sklib_interface_style;
typedef int __sklib_motor_direction;
typedef int __sklib_motor_driver_type;
